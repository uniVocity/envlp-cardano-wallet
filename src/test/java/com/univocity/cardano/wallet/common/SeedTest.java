...
public class SeedTest {
	...
	private void assertErrorMessage(String message, Runnable action) {
		try {
			action.run();
...
//		String seed = "lawsuit lens wood license same give hurt eight bonus dragon kick hammer margin company road clip tornado coin salon pizza whale spell yard benefit";
		String hex = "1acd0cb07d1c493a2175e55a35e8ae392e0813347e38112294d7e730d12bbcfa";
...
//		assertEquals(hexFromSeed, hex);
		...
		System.out.println(seedFromHex);
//		assertEquals(seedFromHex, seed);
	...
	public void testBadEntropyLength() throws Exception {
		...
		assertErrorMessage("Entropy length not multiple of 32 bits.", () -> Seed.generateEnglishSeedPhrase(entropy));
	}
	...
	public void testEmptyEntropy() {
		byte[] entropy = {};
		assertErrorMessage("Entropy is empty.", () -> Seed.generateEnglishSeedPhrase(entropy));
	}
