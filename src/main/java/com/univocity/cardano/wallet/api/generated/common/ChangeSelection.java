...
public final class ChangeSelection {
	...
	@JsonProperty("assets")
	private ArrayList<AssetsChangeSelection> assets;
	 ...
	 */
	public ArrayList<AssetsChangeSelection> getAssets(){
		return assets;
	}
	 ...
	 */
	public void setAssets(ArrayList<AssetsChangeSelection> assets){
		if (assets == null) {
			this.assets = assets;
			return;
		}
