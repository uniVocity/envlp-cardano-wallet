...
public final class OutputsSelection {
	...
	@JsonProperty("assets")
	private ArrayList<AssetsOutputsSelection> assets;
	 ...
	 */
	public ArrayList<AssetsOutputsSelection> getAssets(){
		return assets;
	}
	 ...
	 */
	public void setAssets(ArrayList<AssetsOutputsSelection> assets){
		if (assets == null) {
			this.assets = assets;
			return;
		}
