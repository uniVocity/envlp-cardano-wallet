...
public final class OutputsCoinSelection {
	...
	@JsonProperty("assets")
	private ArrayList<AssetsOutputsCoinSelection> assets;
	 ...
	 */
	public ArrayList<AssetsOutputsCoinSelection> getAssets(){
		return assets;
	}
	 ...
	 */
	public void setAssets(ArrayList<AssetsOutputsCoinSelection> assets){
		if (assets == null) {
			this.assets = assets;
			return;
		}
