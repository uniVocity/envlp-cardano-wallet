...
public final class InputsTransaction {
	...
	@JsonProperty("assets")
	private ArrayList<AssetsInputsTransaction> assets;
	 ...
	 */
	public ArrayList<AssetsInputsTransaction> getAssets(){
		return assets;
	}
	 ...
	 */
	public void setAssets(ArrayList<AssetsInputsTransaction> assets){
		if (assets == null) {
			this.assets = assets;
			return;
		}
