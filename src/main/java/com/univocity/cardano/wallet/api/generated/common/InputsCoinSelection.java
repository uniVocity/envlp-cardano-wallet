...
public final class InputsCoinSelection {
	...
	@JsonProperty("assets")
	private ArrayList<AssetsInputsCoinSelection> assets;
	 ...
	 */
	public ArrayList<AssetsInputsCoinSelection> getAssets(){
		return assets;
	}
	 ...
	 */
	public void setAssets(ArrayList<AssetsInputsCoinSelection> assets){
		if (assets == null) {
			this.assets = assets;
			return;
		}
