...
public final class InputsSelection {
	...
	@JsonProperty("assets")
	private ArrayList<AssetsInputsSelection> assets;
	 ...
	 */
	public ArrayList<AssetsInputsSelection> getAssets(){
		return assets;
	}
	 ...
	 */
	public void setAssets(ArrayList<AssetsInputsSelection> assets){
		if (assets == null) {
			this.assets = assets;
			return;
		}
