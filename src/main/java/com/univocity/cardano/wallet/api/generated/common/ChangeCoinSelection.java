...
public final class ChangeCoinSelection {
	...
	@JsonProperty("assets")
	private ArrayList<AssetsChangeCoinSelection> assets;
	 ...
	 */
	public ArrayList<AssetsChangeCoinSelection> getAssets(){
		return assets;
	}
	 ...
	 */
	public void setAssets(ArrayList<AssetsChangeCoinSelection> assets){
		if (assets == null) {
			this.assets = assets;
			return;
		}
